                              ...
                              child: SizedBox(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                        Card(context, "assets/images/planet/bumi.png", "Bumi", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                        Card(context, "assets/images/planet/jupiter.png", "Jupiter", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Card(context, "assets/images/planet/mars.png", "Mars", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                        Card(context, "assets/images/planet/mercury.png", "Merkurius", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Card(context, "assets/images/planet/neptune.png", "Neptunus", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                        Card(context, "assets/images/planet/saturn.png", "Saturnus", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                      ],
                                    ),
                                    Row(
                                      children: [
                                        Card(context, "assets/images/planet/uranus.png", "Uranus", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                        Card(context, "assets/images/planet/venus.png", "Venus", lorem,
                                            MediaQuery.of(context).size.width / 2 - 40, MediaQuery.of(context).size.height / 5),
                                      ],
                                    ),
                                  ],
